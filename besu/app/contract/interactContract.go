...
func SetContract(value uint) (*types.Receipt, error) {
	...
	abiFile, err := os.ReadFile("../artifacts/contracts/SimpleStorage.sol/SimpleStorage.json") // found under besu/artifacts/contracts/SimpleStorage.sol/SimpleStorage.json
	if err != nil {
